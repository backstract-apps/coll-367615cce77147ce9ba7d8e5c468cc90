...
app = FastAPI(title='Backstract Generated APIs - coll-367615cce77147ce9ba7d8e5c468cc90', debug=False,
              docs_url='/naughty-torvalds-34dd32f83f9611f08cfe225360bf993d85/docs',
              openapi_url='/naughty-torvalds-34dd32f83f9611f08cfe225360bf993d85/openapi.json')
...
app.include_router(
    router,
    prefix='/naughty-torvalds-34dd32f83f9611f08cfe225360bf993d85/api',
    tags=['APIs v1']
)
